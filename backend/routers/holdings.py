...
def analyze(items: List[HoldItem]):
    ...
    from services.data import get_nav, get_all_funds, get_short_term_perf, get_full_holdings
    ...
    from services.direction import get_fund_direction, _STOCK_SECTOR
